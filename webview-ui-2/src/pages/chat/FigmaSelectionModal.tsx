...
export const FigmaSelectionModal = () => {
  const { isSelectionModalOpen, figmaLink, setFigmaLink, submitSelection, closeSelectionModal } = useAttachment();

  const handleOpenChange = useCallback(() => closeSelectionModal(), [closeSelectionModal]);
